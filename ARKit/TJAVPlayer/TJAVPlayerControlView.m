...
- (UIButton *)bgButton {
    if (!_bgButton) {
        ...
        [_bgButton setImage:kGetARImage(@"play") forState:UIControlStateNormal];
...
- (void)bgButtonAction {
    ...
    if (self.isPlaying) {
        [_bgButton setImage:kGetARImage(@"") forState:UIControlStateNormal];
...
- (UIButton *)backButton {
    if (!_backButton) {
        ...
        _backButton.frame = CGRectMake(20, kIphoneXStatusBarHeight, 40, 40);
...
- (void)layoutSubviews
{
    ...
    self.backButton.frame = CGRectMake(20, kIphoneXStatusBarHeight, 40, 40);
